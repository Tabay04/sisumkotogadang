...
<body style='background-color:white;'>
    ...
    <div class="row">
        <div class='col-sm-2'></div>
        <div class="col-sm-8">
            <div style='text-align:center;'> <u><a class="satu">SURAT KETERANGAN USAHA</a></u>
                <br>
        ...
        <div class="col-sm-8">
            <div class='row'>
                ...
                <div class='col-sm-7'>
                    ...
                    <?php echo $hasil['data'][0]['jenis_pekerjaan'] ?> <br>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <br> 
            <p class="tiga">
            nama yang tersebut diatas adalah benar penduduk Jorong <?php echo $hasil['data'][0]['alamat'] ?> yang menurut keterangan yang bersangkutan mempunyai  <?php echo $hasil['data'][0]['nama_jenis_usaha'] ?> di Jorong <?php echo $hasil['data'][0]['nama_jorong'] ?>, dari tahun <?php echo $hasil['data'][0]['tahun_usaha'] ?>. <br>
            <br>    
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikianlah surat keterangan usaha ini kami berikan untuk dapat dipergunakan seperlunya. </p><br>
        </div>
        <div class="col-sm-2"></div>
    </div>
