...
<body style='background-color:white;'>
    ...
    <div class="row">
        <div class='col-sm-2'></div>
        <div class="col-sm-8">
            <div style='text-align:center;'> <u><a class="satu">SURAT KETERANGAN MENINGGAL DUNIA</a></u>
                <br>
                <b>Nomor: <?php echo $no;?></b>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <br>
                <p class="tiga">Telah meninggal dunia tanggal <?php echo date('d F Y', strtotime($hasil['data'][0]['tanggal_meninggal'])) ?>   Pukul <?php echo $hasil['data'][0]['pukul'] ?> WIB di <?php echo $hasil['data'][0]['kota'] ?> dan dikuburkan di <?php echo $hasil['data'][0]['dikuburkan'] ?>.</p>
                <p class="tiga">Surat keterangan ini dibuat berdasarkan keterangan pelapor:</p>
                 <div class='row'>
                    <div class='col-sm-4'>
                        <div class="tiga">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nama Lengkap <br>
                    ...
                    <div class='col-sm-7'>
                        ...
                        $nik_pelapor = $hasil['data'][0]['nik_pelapor'];
                        $result = pg_query($conn, "SELECT penduduk.nama_lengkap as nama_lengkap, penduduk.jenis_pekerjaan as pekerjaan, rumah.alamat FROM penduduk JOIN kk ON penduduk.no_kk=kk.no_kk JOIN rumah ON rumah.id_rumah=kk.id_rumah WHERE nik='$nik_pelapor'");
                        $pelapor = pg_fetch_assoc($result);
                        // var_dump($pelapor); exit();
                        ?>
                        <?php echo $pelapor['nama_lengkap'] ?><br>
                        <?php echo $hasil['data'][0]['nik_pelapor'] ?> <br>
                        <?php echo $pelapor['pekerjaan'] ?> <br>
                        <?php echo $pelapor['alamat'] ?> 
                        </div>
                    </div> 
            </div>
            <br>
            <p class="tiga">Hubungan pelapor dengan almarhum: <?php echo $hasil['data'][0]['hubungan'] ?>.</p> 
        </div>
    </div>
    <div class="row">
        <div class='col-sm-2'></div>
